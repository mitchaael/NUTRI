        ...
        {status==='found'&&found&&(
          <div style={{animation:'fadeUp .3s ease'}}>
            ...
            <div style={{display:'flex',gap:8}}>
              ...
              <button className="tap" onClick={()=>onFound(found)} style={{flex:2,padding:'13px',borderRadius:16,border:'none',background:'#007AFF',color:'white',fontSize:14,fontWeight:700,cursor:'pointer',fontFamily:F}}>Agregar al diario</button>
            </div>
          </div>
        )}
