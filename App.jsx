  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        filter:phase>=1?'drop-shadow(0 8px 40px rgba(0,0,0,0.5))':'none',
      }}>
        <img src={ICON_URL} alt="Calorú"
...
function Onboarding({onDone}) {
  ...
  const steps=[
    ...
    <div key={0} style={{display:'flex',flexDirection:'column',alignItems:'center',padding:'40px 28px',gap:24,textAlign:'center'}}>
      <img src={ICON_URL} alt="Calorú" style={{width:80,height:80,borderRadius:20}}/>
      <div>
