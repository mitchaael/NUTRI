      ...
      <div style={{padding:'14px 14px 0'}}>
        ...
        {tab===2&&<div className={tabAnim}>
          ...
          <div style={{display:'flex',gap:8,marginBottom:14}}>
            <button className="tap" onClick={()=>setShowHistory(true)} style={{flex:1,padding:'11px 8px',borderRadius:16,border:`1px solid ${C.border}`,background:C.surface,display:'flex',alignItems:'center',justifyContent:'center',gap:6,cursor:'pointer',fontFamily:F}}>
              <span style={{fontSize:18}}>📅</span>
              <span style={{fontSize:12,fontWeight:600,color:C.text}}>Historial</span>
            </button>
          </div>
  ...
  fontSize:14,fontWeight:600,cursor:'pointer',fontFamily:F,marginTop:4,
        ...
        {tab===3&&<div className={tabAnim}>
          ...
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:8,marginBottom:12}}>
            <button className="tap" onClick={()=>setShowHistory(true)} style={{padding:'14px 12px',borderRadius:18,border:`1px solid ${C.border}`,background:C.surface,display:'flex',flexDirection:'column',alignItems:'center',gap:6,cursor:'pointer',fontFamily:F}}>
              <div style={{width:44,height:44,borderRadius:14,background:'#007AFF14',display:'flex',alignItems:'center',justifyContent:'center',fontSize:24}}>📅</div>
              <div style={{fontSize:12,fontWeight:700,color:C.text}}>Historial</div>
              <div style={{fontSize:10,color:C.textSec}}>14 días</div>
            </button>
            <button className="tap" onClick={()=>setShowPlanner(true)} style={{padding:'14px 12px',borderRadius:18,border:`1px solid ${C.border}`,background:C.surface,display:'flex',flexDirection:'column',alignItems:'center',gap:6,cursor:'pointer',fontFamily:F}}>
              <div style={{width:44,height:44,borderRadius:14,background:'#FF950014',display:'flex',alignItems:'center',justifyContent:'center',fontSize:24}}>🗓️</div>
              <div style={{fontSize:12,fontWeight:700,color:C.text}}>Plan semanal</div>
              <div style={{fontSize:10,color:C.textSec}}>+ Lista compras</div>
            </button>
          </div>
