...
const DB = [
  ...
  {id:400,nombre:"Pan molde Líder blanco",          marca:"Líder",        cat:"Panes",      porcion:30,  cal:72,  prot:2.5, carbs:14,  grasas:0.8, fibra:0.5, emoji:"🍞"},
  {id:401,nombre:"Pan molde Líder integral",        marca:"Líder",        cat:"Panes",      porcion:30,  cal:66,  prot:3,   carbs:12,  grasas:0.8, fibra:2.5, emoji:"🍞"},
  {id:402,nombre:"Leche entera Líder",              marca:"Líder",        cat:"Lácteos",    porcion:250, cal:155, prot:8,   carbs:12,  grasas:8.5, fibra:0,   emoji:"🥛"},
  {id:403,nombre:"Yogurt natural Líder",            marca:"Líder",        cat:"Lácteos",    porcion:150, cal:115, prot:6,   carbs:14,  grasas:3.5, fibra:0,   emoji:"🥣"},
  {id:404,nombre:"Arroz grano largo Líder",         marca:"Líder",        cat:"Granos",     porcion:50,  cal:178, prot:3.5, carbs:39,  grasas:0.4, fibra:0.5, emoji:"🍚"},
  {id:405,nombre:"Aceite maravilla Líder",          marca:"Líder",        cat:"Aceites",    porcion:15,  cal:124, prot:0,   carbs:0,   grasas:14,  fibra:0,   emoji:"🫙"},
  {id:406,nombre:"Azúcar Líder",                    marca:"Líder",        cat:"Condimentos",porcion:5,   cal:20,  prot:0,   carbs:5,   grasas:0,   fibra:0,   emoji:"🍬"},
  {id:407,nombre:"Fideos Líder espagueti",          marca:"Líder",        cat:"Granos",     porcion:80,  cal:288, prot:10,  carbs:57,  grasas:1.5, fibra:2.5, emoji:"🍝"},
  {id:408,nombre:"Atún Líder al agua",              marca:"Líder",        cat:"Pescados",   porcion:100, cal:98,  prot:22,  carbs:0,   grasas:1,   fibra:0,   emoji:"🥫"},
  {id:409,nombre:"Porotos negros Líder",            marca:"Líder",        cat:"Legumbres",  porcion:100, cal:127, prot:8.5, carbs:23,  grasas:0.5, fibra:7,   emoji:"🫘"},
  {id:410,nombre:"Granola Líder con miel",          marca:"Líder",        cat:"Cereales",   porcion:45,  cal:188, prot:4,   carbs:32,  grasas:5.5, fibra:3,   emoji:"🥣"},
  {id:411,nombre:"Leche condensada Líder",          marca:"Líder",        cat:"Lácteos",    porcion:40,  cal:128, prot:3,   carbs:22,  grasas:3.5, fibra:0,   emoji:"🥛"},
  {id:412,nombre:"Mantequilla Líder con sal",       marca:"Líder",        cat:"Lácteos",    porcion:10,  cal:71,  prot:0.1, carbs:0,   grasas:8,   fibra:0,   emoji:"🧈"},
  {id:413,nombre:"Mote Unimarc",                    marca:"Unimarc",      cat:"Granos",     porcion:100, cal:155, prot:4,   carbs:33,  grasas:0.8, fibra:2,   emoji:"🌾"},
  {id:414,nombre:"Lentejas Unimarc",                marca:"Unimarc",      cat:"Legumbres",  porcion:60,  cal:202, prot:14,  carbs:33,  grasas:0.8, fibra:11,  emoji:"🫘"},
  {id:415,nombre:"Avena Unimarc",                   marca:"Unimarc",      cat:"Cereales",   porcion:45,  cal:168, prot:5.5, carbs:30,  grasas:2.8, fibra:4,   emoji:"🌾"},
  {id:416,nombre:"Mermelada frutilla Unimarc",      marca:"Unimarc",      cat:"Condimentos",porcion:20,  cal:44,  prot:0.1, carbs:11,  grasas:0,   fibra:0.3, emoji:"🍓"},
  {id:417,nombre:"Leche entera Santa Isabel",       marca:"Santa Isabel", cat:"Lácteos",    porcion:250, cal:158, prot:8,   carbs:12,  grasas:9,   fibra:0,   emoji:"🥛"},
  {id:418,nombre:"Pan marraqueta Santa Isabel",     marca:"Santa Isabel", cat:"Panes",      porcion:80,  cal:225, prot:7,   carbs:43,  grasas:2.5, fibra:2,   emoji:"🍞"},
  {id:419,nombre:"Pollo entero Jumbo",              marca:"Jumbo",        cat:"Carnes",     porcion:100, cal:172, prot:20,  carbs:0,   grasas:10,  fibra:0,   emoji:"🍗"},
  {id:420,nombre:"Hamburguesa vacuno Jumbo 4pack",  marca:"Jumbo",        cat:"Carnes",     porcion:115, cal:285, prot:20,  carbs:1,   grasas:22,  fibra:0,   emoji:"🍔"},

  /* ── COMIDA RÁPIDA CHILENA MÁS COMPLETA ── */
  {id:430,nombre:"Sopaipilla con pebre",            marca:"Artesanal",    cat:"Comidas CL", porcion:80,  cal:198, prot:3.5, carbs:28,  grasas:8,   fibra:1.5, emoji:"🫓"},
  {id:431,nombre:"Cazuela de pollo",                marca:"Artesanal",    cat:"Comidas CL", porcion:400, cal:245, prot:22,  carbs:26,  grasas:6,   fibra:3,   emoji:"🍲"},
  {id:432,nombre:"Chupe de locos",                  marca:"Artesanal",    cat:"Comidas CL", porcion:300, cal:380, prot:24,  carbs:22,  grasas:18,  fibra:1,   emoji:"🍲"},
  {id:433,nombre:"Pantrucas",                       marca:"Artesanal",    cat:"Comidas CL", porcion:350, cal:295, prot:12,  carbs:42,  grasas:8,   fibra:3,   emoji:"🍲"},
  {id:434,nombre:"Choripán",                        marca:"Artesanal",    cat:"Comidas CL", porcion:180, cal:480, prot:18,  carbs:38,  grasas:26,  fibra:2,   emoji:"🌭"},
  {id:435,nombre:"Leche asada",                     marca:"Artesanal",    cat:"Comidas CL", porcion:150, cal:195, prot:7,   carbs:28,  grasas:6,   fibra:0,   emoji:"🍮"},
  {id:436,nombre:"Calzón roto",                     marca:"Artesanal",    cat:"Comidas CL", porcion:60,  cal:245, prot:3,   carbs:30,  grasas:13,  fibra:0.5, emoji:"🍩"},
  {id:437,nombre:"Manzana con canela horneada",     marca:"Natural",      cat:"Comidas CL", porcion:180, cal:120, prot:0.5, carbs:30,  grasas:0.5, fibra:3.5, emoji:"🍎"},
  {id:438,nombre:"Api morado",                      marca:"Artesanal",    cat:"Bebidas",    porcion:250, cal:145, prot:1,   carbs:35,  grasas:0.5, fibra:1,   emoji:"🫐"},
  {id:439,nombre:"Chicha de uva sin alcohol",       marca:"Artesanal",    cat:"Bebidas",    porcion:250, cal:155, prot:0.5, carbs:38,  grasas:0,   fibra:0,   emoji:"🍇"},
  {id:440,nombre:"Longaniza a la parrilla",         marca:"Artesanal",    cat:"Carnes",     porcion:80,  cal:280, prot:12,  carbs:2,   grasas:24,  fibra:0,   emoji:"🌭"},
  {id:441,nombre:"Valdiviano",                      marca:"Artesanal",    cat:"Comidas CL", porcion:300, cal:210, prot:18,  carbs:15,  grasas:8,   fibra:2,   emoji:"🍲"},
  {id:442,nombre:"Milcao de papa",                  marca:"Artesanal",    cat:"Comidas CL", porcion:120, cal:265, prot:5,   carbs:42,  grasas:9,   fibra:2.5, emoji:"🫓"},
  {id:443,nombre:"Chapalele",                       marca:"Artesanal",    cat:"Comidas CL", porcion:100, cal:195, prot:3,   carbs:38,  grasas:3,   fibra:2,   emoji:"🫓"},
  {id:444,nombre:"Pebre (porción)",                 marca:"Natural",      cat:"Condimentos",porcion:50,  cal:28,  prot:0.8, carbs:5,   grasas:1,   fibra:1.5, emoji:"🌿"},
  {id:445,nombre:"Chancho en piedra",               marca:"Natural",      cat:"Condimentos",porcion:50,  cal:22,  prot:0.7, carbs:4,   grasas:0.8, fibra:1,   emoji:"🍅"},

  /* ── CAFETERÍA / PANADERÍA ── */
  {id:450,nombre:"Café de grano con leche",         marca:"Cafetería",    cat:"Bebidas",    porcion:200, cal:85,  prot:4,   carbs:9,   grasas:3.5, fibra:0,   emoji:"☕"},
  {id:451,nombre:"Cappuccino",                      marca:"Cafetería",    cat:"Bebidas",    porcion:180, cal:95,  prot:5,   carbs:10,  grasas:4,   fibra:0,   emoji:"☕"},
  {id:452,nombre:"Empanada napolitana horneada",    marca:"Artesanal",    cat:"Comidas CL", porcion:145, cal:320, prot:13,  carbs:35,  grasas:14,  fibra:1,   emoji:"🥟"},
  {id:453,nombre:"Dobladita",                       marca:"Artesanal",    cat:"Panes",      porcion:70,  cal:210, prot:6,   carbs:36,  grasas:5,   fibra:1.5, emoji:"🥐"},
  {id:454,nombre:"Pan amasado",                     marca:"Artesanal",    cat:"Panes",      porcion:60,  cal:185, prot:5,   carbs:34,  grasas:4,   fibra:1,   emoji:"🍞"},
  {id:455,nombre:"Tortilla de rescoldo",            marca:"Artesanal",    cat:"Panes",      porcion:80,  cal:240, prot:6,   carbs:42,  grasas:5.5, fibra:1.5, emoji:"🫓"},
  {id:456,nombre:"Pan de huevo",                    marca:"Artesanal",    cat:"Panes",      porcion:50,  cal:165, prot:4.5, carbs:28,  grasas:4,   fibra:0.5, emoji:"🍞"},

  /* ── SNACKS CHILENOS ── */
  {id:460,nombre:"Chicharrón de cerdo",             marca:"Genérico",     cat:"Snacks",     porcion:30,  cal:185, prot:12,  carbs:0,   grasas:15,  fibra:0,   emoji:"🥓"},
  {id:461,nombre:"Maní con cáscara tostado",        marca:"Genérico",     cat:"Snacks",     porcion:30,  cal:172, prot:7.5, carbs:5,   grasas:14,  fibra:2.5, emoji:"🥜"},
  {id:462,nombre:"Empolvados",                      marca:"Artesanal",    cat:"Snacks",     porcion:30,  cal:125, prot:1.5, carbs:18,  grasas:5.5, fibra:0.3, emoji:"🍪"},
  {id:463,nombre:"Galletas de vino",                marca:"Artesanal",    cat:"Snacks",     porcion:30,  cal:130, prot:2,   carbs:21,  grasas:4.5, fibra:0.5, emoji:"🍪"},
  {id:464,nombre:"Rosquillas",                      marca:"Artesanal",    cat:"Snacks",     porcion:40,  cal:175, prot:2.5, carbs:28,  grasas:6,   fibra:0.5, emoji:"🍩"},
  {id:465,nombre:"Queque de naranja (porción)",     marca:"Artesanal",    cat:"Snacks",     porcion:80,  cal:290, prot:4,   carbs:40,  grasas:13,  fibra:0.5, emoji:"🍰"},
  {id:466,nombre:"Tres leches (porción)",           marca:"Artesanal",    cat:"Snacks",     porcion:120, cal:380, prot:7,   carbs:48,  grasas:17,  fibra:0,   emoji:"🍰"},

  /* ── FRUTAS CHILENAS DE TEMPORADA ── */
  {id:470,nombre:"Nectarina",                       marca:"Natural",      cat:"Frutas",     porcion:130, cal:55,  prot:1.5, carbs:13,  grasas:0.3, fibra:2,   emoji:"🍑"},
  {id:471,nombre:"Tuna (higo chumbo)",              marca:"Natural",      cat:"Frutas",     porcion:80,  cal:50,  prot:0.7, carbs:13,  grasas:0.5, fibra:3.5, emoji:"🌵"},
  {id:472,nombre:"Papaya chilena",                  marca:"Natural",      cat:"Frutas",     porcion:150, cal:62,  prot:0.6, carbs:16,  grasas:0.1, fibra:1.5, emoji:"🍈"},
  {id:473,nombre:"Membrillo",                       marca:"Natural",      cat:"Frutas",     porcion:100, cal:57,  prot:0.4, carbs:15,  grasas:0.1, fibra:1.9, emoji:"🍋"},
  {id:474,nombre:"Damasco",                         marca:"Natural",      cat:"Frutas",     porcion:80,  cal:38,  prot:0.9, carbs:9,   grasas:0.1, fibra:1.5, emoji:"🍑"},
  {id:475,nombre:"Mora",                            marca:"Natural",      cat:"Frutas",     porcion:100, cal:43,  prot:1.4, carbs:10,  grasas:0.5, fibra:5,   emoji:"🫐"},

  /* ── SUPERMERCADO — MÁS MARCAS ── */
  {id:480,nombre:"Fideos Carozzi macarrón",         marca:"Carozzi",      cat:"Granos",     porcion:80,  cal:290, prot:10,  carbs:58,  grasas:1.5, fibra:2,   emoji:"🍝"},
  {id:481,nombre:"Salsa bolognesa Malloa",          marca:"Malloa",       cat:"Condimentos",porcion:125, cal:110, prot:6,   carbs:12,  grasas:4,   fibra:2,   emoji:"🫙"},
  {id:482,nombre:"Mermelada damasco Watts",         marca:"Watts",        cat:"Condimentos",porcion:20,  cal:46,  prot:0.1, carbs:11,  grasas:0,   fibra:0.3, emoji:"🍑"},
  {id:483,nombre:"Galletas Soda Carozzi",           marca:"Carozzi",      cat:"Snacks",     porcion:30,  cal:128, prot:2.5, carbs:21,  grasas:4,   fibra:0.5, emoji:"🍘"},
  {id:484,nombre:"Chocapic Nestlé",                 marca:"Nestlé",       cat:"Cereales",   porcion:30,  cal:118, prot:2.5, carbs:24,  grasas:1.5, fibra:1.5, emoji:"🥣"},
  {id:485,nombre:"Jugo en polvo Zuko",              marca:"Zuko",         cat:"Bebidas",    porcion:200, cal:80,  prot:0,   carbs:20,  grasas:0,   fibra:0,   emoji:"🧃"},
  {id:486,nombre:"Néctar Watt's durazno",           marca:"Watt's",       cat:"Bebidas",    porcion:200, cal:90,  prot:0.3, carbs:22,  grasas:0,   fibra:0,   emoji:"🧃"},
  {id:487,nombre:"Bebida Kem naranja lata",         marca:"CCU",          cat:"Bebidas",    porcion:350, cal:148, prot:0,   carbs:37,  grasas:0,   fibra:0,   emoji:"🥤"},
  {id:488,nombre:"Manjar La Lechera",               marca:"Nestlé",       cat:"Lácteos",    porcion:15,  cal:56,  prot:0.9, carbs:12,  grasas:0.6, fibra:0,   emoji:"🍯"},
  {id:489,nombre:"Crema pastelera Soprole",         marca:"Soprole",      cat:"Lácteos",    porcion:50,  cal:88,  prot:1.8, carbs:14,  grasas:3,   fibra:0,   emoji:"🫙"},
  {id:490,nombre:"Jamón planchado Ariztía",         marca:"Ariztía",      cat:"Cecinas",    porcion:25,  cal:42,  prot:7,   carbs:0.5, grasas:1.5, fibra:0,   emoji:"🥩"},
  {id:491,nombre:"Longaniza Montserrat",            marca:"Montserrat",   cat:"Cecinas",    porcion:50,  cal:155, prot:8,   carbs:1.5, grasas:13,  fibra:0,   emoji:"🌭"},
  {id:492,nombre:"Queso fresco Colun",              marca:"Colun",        cat:"Lácteos",    porcion:30,  cal:70,  prot:5,   carbs:1,   grasas:5.5, fibra:0,   emoji:"🧀"},
  {id:493,nombre:"Crema de leche Colun",            marca:"Colun",        cat:"Lácteos",    porcion:30,  cal:98,  prot:0.7, carbs:0.9, grasas:10,  fibra:0,   emoji:"🫙"},
  {id:494,nombre:"Yogurt de coco Soprole",          marca:"Soprole",      cat:"Lácteos",    porcion:150, cal:155, prot:5,   carbs:18,  grasas:6.5, fibra:0,   emoji:"🥣"},
  {id:495,nombre:"Cereal Lucky Charms",             marca:"General Mills",cat:"Cereales",   porcion:28,  cal:110, prot:2,   carbs:24,  grasas:1,   fibra:1.5, emoji:"🌈"},
...
/* ═══════════════════════════════════════════════════════
   ALERGIAS — mapa de alérgenos por id de producto
   Alérgenos: gluten, lactosa, huevo, frutos_secos,
              mariscos, pescado, soja, mostaza, sésamo
═══════════════════════════════════════════════════════ */
const ALLERGEN_MAP = {
  /* Lácteos */
  1:'lactosa',2:'lactosa',3:'lactosa',4:'lactosa',5:'lactosa',6:'lactosa',
  7:'lactosa',8:'lactosa',9:'lactosa',10:'lactosa',11:'lactosa',12:'lactosa',
  13:'lactosa',14:'lactosa',15:'lactosa',16:'lactosa',17:'lactosa',18:'lactosa',
  19:'lactosa',20:'lactosa',21:'lactosa',22:'lactosa',23:'lactosa',24:'lactosa',
  25:'lactosa',26:'lactosa',27:'lactosa',28:'lactosa',29:'lactosa',30:'lactosa',31:'lactosa',
  402:'lactosa',403:'lactosa',411:'lactosa',412:'lactosa',417:'lactosa',
  488:'lactosa',489:'lactosa',492:'lactosa',493:'lactosa',494:'lactosa',
  /* Panes/Cereales con gluten */
  80:'gluten',81:'gluten',82:'gluten',83:'gluten',84:'gluten',85:'gluten',
  87:'gluten',88:'gluten',89:'gluten',90:'gluten',91:'gluten',93:'gluten',
  100:'gluten',101:'gluten',102:'gluten',103:'gluten',104:'gluten',105:'gluten',
  106:'gluten',107:'gluten',108:'gluten',110:'gluten',
  237:'gluten',238:'gluten',239:'gluten',240:'gluten',
  400:'gluten',401:'gluten',407:'gluten',418:'gluten',
  453:'gluten',454:'gluten',455:'gluten',456:'gluten',
  480:'gluten',481:'gluten',483:'gluten',
  /* Snacks con gluten */
  120:'gluten',121:'gluten',122:'gluten',123:'gluten',124:'gluten',
  138:'gluten',462:'gluten',463:'gluten',464:'gluten',
  /* Huevo */
  265:'huevo',266:'huevo',267:'huevo',268:'huevo',
  /* Frutos secos */
  58:'frutos_secos',59:'frutos_secos',132:'frutos_secos',133:'frutos_secos',
  134:'frutos_secos',136:'frutos_secos',461:'frutos_secos',
  /* Pescado */
  250:'pescado',251:'pescado',252:'pescado',253:'pescado',256:'pescado',
  259:'pescado',260:'pescado',
  /* Mariscos */
  254:'mariscos',255:'mariscos',257:'mariscos',258:'mariscos',
  107:'mariscos',
  /* Soja */
  /* (soja en productos procesados — marcado caso a caso) */
};

/* Alérgenos múltiples (override map arriba para estos) */
const MULTI_ALLERGENS = {
  /* empanadas: gluten + huevo */
  280:['gluten','huevo'], 281:['gluten','huevo'], 282:['gluten','huevo'],
  452:['gluten','huevo'],
  /* pastas: gluten + huevo (si son al huevo) */
  /* galletas con lácteos */
  48:['gluten','lactosa'], 49:['gluten','lactosa'], 51:['gluten','lactosa'],
  52:['gluten','lactosa'], 53:['gluten'],
  /* cereales de desayuno con gluten + lactosa posible */
  47:['gluten','lactosa'],
  /* kuchen */
  130:['gluten','huevo','lactosa'],
  435:['lactosa','huevo'], // leche asada
  466:['gluten','huevo','lactosa'], // tres leches
  465:['gluten','huevo','lactosa'], // queque
};

const ALLERGEN_LABELS = {
  gluten:      {icon:'🌾', label:'Gluten',      color:'#C07C24'},
  lactosa:     {icon:'🥛', label:'Lactosa',     color:'#4A86C8'},
  huevo:       {icon:'🥚', label:'Huevo',       color:'#FFD60A'},
  frutos_secos:{icon:'🥜', label:'Frutos secos',color:'#C8784A'},
  pescado:     {icon:'🐟', label:'Pescado',     color:'#3A8FC8'},
  mariscos:    {icon:'🦐', label:'Mariscos',    color:'#E07B4A'},
  soja:        {icon:'🫘', label:'Soja',        color:'#5C8A3A'},
  mostaza:     {icon:'🟡', label:'Mostaza',     color:'#D4A830'},
  sesamo:      {icon:'🌰', label:'Sésamo',      color:'#A07030'},
};

const ALL_ALLERGENS = Object.keys(ALLERGEN_LABELS);

const getFoodAllergens = (id) => {
  if(MULTI_ALLERGENS[id]) return MULTI_ALLERGENS[id];
  if(ALLERGEN_MAP[id]) return [ALLERGEN_MAP[id]];
  return [];
};

const foodHasAllergen = (food, activeAllergens) => {
  if(!activeAllergens || activeAllergens.length===0) return false;
  const fa = getFoodAllergens(food.id);
  return fa.some(a => activeAllergens.includes(a));
};
...
const LS = {
  get:(k,d)=>{
    try{const v=localStorage.getItem('caloru_'+k);return v!=null?JSON.parse(v):d;}
    catch{return d;}
  },
  set:(k,v)=>{
    try{localStorage.setItem('caloru_'+k,JSON.stringify(v));}
    catch(e){
      // localStorage full — try to free space by removing old day logs
      try{
        const keys=Object.keys(localStorage).filter(k=>k.startsWith('caloru_log_')||k.startsWith('caloru_photo_'));
        if(keys.length>0){
          keys.sort().slice(0,Math.ceil(keys.length/2)).forEach(k=>localStorage.removeItem(k));
          localStorage.setItem('caloru_'+k,JSON.stringify(v));
        }
      }catch{}
    }
  },
  remove:(k)=>{try{localStorage.removeItem('caloru_'+k);}catch{}},
};

/* ═══════════════════════════════════════════════════════
   DESIGN SYSTEM
═══════════════════════════════════════════════════════ */
/* Accent colors per objective */
const OBJ_ACCENT = {
  bajar:   {light:'#FF3B30', dark:'#FF453A', name:'Bajar peso'},
  mantener:{light:'#007AFF', dark:'#0A84FF', name:'Mantenimiento'},
  recomp:  {light:'#AF52DE', dark:'#BF5AF2', name:'Recomposición'},
  subir:   {light:'#34C759', dark:'#30D158', name:'Ganar masa'},
};
...
function Splash({onDone}) {
  ...
  useEffect(()=>{
    ...
    const t2=setTimeout(()=>setBarW(100), 700);
    const t3=setTimeout(()=>setPhase(3), 2000);
    const t4=setTimeout(()=>onDone(), 2450);
...
function BarcodeScanner({C, F, onFound, onClose}) {
  ...
  const [status,  setStatus] = useState('loading'); // loading|scanning|looking|found|error|manual
  ...
  const startScanner = async() => {
    ...
    try {
      ...
      /* 3. Conectar stream al <video> — iOS safe */
      const vid = videoRef.current;
      if(!vid) { stopAll(); return; }
      ...
      /* iOS needs explicit play() after srcObject assignment */
      ...
      try { await vid.play(); } catch(playErr) {
  ...
  return(
    <div onClick={onClose} style={{position:'fixed',inset:0,background:'rgba(0,0,0,0.88)',zIndex:70,display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'flex-end'}}>
      <div onClick={e=>e.stopPropagation()} style={{width:'100%',background:C.surface,borderRadius:'26px 26px 0 0',padding:'18px 18px 48px',animation:'slideUp .3s ease'}}>
        ...
        {/* Error */}
        {status==='error'&&(
          <div style={{padding:'8px 0 8px',marginBottom:8,animation:'fadeUp .3s ease'}}>
            <div style={{textAlign:'center',marginBottom:16}}>
              <div style={{fontSize:36,marginBottom:8}}>😕</div>
              <div style={{fontSize:15,fontWeight:700,color:C.text,marginBottom:6}}>No se encontró el producto</div>
              <div style={{fontSize:12,color:C.textSec,lineHeight:1.5}}>{errMsg}</div>
            </div>
            <div style={{display:'flex',gap:8,marginBottom:14}}>
              ...
              <button className="tap" onClick={()=>setStatus('manual')} style={{flex:1,padding:'12px',borderRadius:16,border:'none',background:'#007AFF',color:'white',fontSize:13,fontWeight:600,cursor:'pointer',fontFamily:F}}>✏️ Agregar manual</button>
            </div>
          </div>
        )}
        {status==='manual'&&(
          <ManualProductEntry C={C} F={F} barcode={found?.barcode||''} onSave={onFound} onBack={()=>setStatus('error')}/>
        )}
      </div>
    </div>
  );
...
═══════════════════════════════════════════════════════ */
function ManualProductEntry({C, F, barcode, onSave, onBack}) {
  ...
  return(
    <div style={{animation:'fadeUp .25s ease'}}>
      ...
      {barcode&&<div style={{fontSize:11,color:C.textMuted,marginBottom:12}}>Código: {barcode}</div>}
      <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:8,marginBottom:12}}>
        <div style={{gridColumn:'1/-1'}}>
          <div style={{fontSize:10,color:C.textSec,fontWeight:700,textTransform:'uppercase',marginBottom:4}}>Nombre *</div>
          <input value={food.nombre} onChange={e=>setFood({...food,nombre:e.target.value})}
        ...
        <div style={{gridColumn:'1/-1'}}>
          <div style={{fontSize:10,color:C.textSec,fontWeight:700,textTransform:'uppercase',marginBottom:4}}>Marca</div>
        ...
        {[
          {l:'Porción (g)',k:'porcion',bold:false},
          {l:'Calorías *',k:'cal',bold:true},
          {l:'Proteínas (g)',k:'prot',bold:false},
          {l:'Carbs (g)',k:'carbs',bold:false},
          {l:'Grasas (g)',k:'grasas',bold:false},
          {l:'Fibra (g)',k:'fibra',bold:false},
        ].map(({l,k,bold})=>(
          <div key={k}>
            <div style={{fontSize:10,color:C.textSec,fontWeight:700,textTransform:'uppercase',marginBottom:4}}>{l}</div>
            <input type="number" min="0" value={food[k]}
              onChange={e=>setFood({...food,[k]:+e.target.value||0})}
              style={{width:'100%',padding:'10px 12px',border:`1.5px solid ${bold&&food[k]>0?'#007AFF':C.border}`,borderRadius:12,fontSize:15,fontWeight:bold?800:500,fontFamily:F,color:C.text,background:C.surfaceAlt,outline:'none'}}/>
          </div>
        ))}
      </div>
      <div style={{display:'flex',gap:8}}>
        ...
        <button className="tap" onClick={()=>{
          ...
          onSave({
            ...
            cat:'Escaneado',
            porcion:food.porcion||100,
            cal:food.cal, prot:food.prot, carbs:food.carbs,
            grasas:food.grasas, fibra:food.fibra,
            emoji:'📦', barcode,
          });
  ...
  return(
    <div style={{position:'fixed',inset:0,background:C.bg,zIndex:80,display:'flex',flexDirection:'column',animation:'fadeUp .3s ease'}}>
      ...
      <div style={{background:C.surface,borderBottom:`1px solid ${C.border}`,padding:'14px 16px',display:'flex',alignItems:'center',gap:10,flexShrink:0}}>
        <button onClick={onClose} style={{background:'none',border:'none',fontSize:16,cursor:'pointer',color:'#007AFF',fontFamily:F,fontWeight:600,padding:4}}>✕</button>
        <div style={{flex:1,fontSize:15,fontWeight:700,color:C.text,textAlign:'center'}}>
          {view==='plan'?'🗓️ Plan semanal':'🛒 Lista de compras'}
        </div>
        <button onClick={()=>setView(view==='plan'?'shopping':'plan')} style={{background:'#007AFF18',border:'none',padding:'6px 10px',borderRadius:12,fontSize:11,fontWeight:700,color:'#007AFF',cursor:'pointer',fontFamily:F,flexShrink:0}}>
          {view==='plan'?'🛒':'🗓️'}
        </button>
      </div>
          ...
          <>
            {days.map(({key,label})=>(
              <div key={key} style={{marginBottom:14}}>
                ...
                <div style={{fontSize:13,fontWeight:key===new Date().toISOString().slice(0,10)?800:700,
                  color:key===new Date().toISOString().slice(0,10)?'#007AFF':C.textSec,
                  textTransform:'uppercase',letterSpacing:.4}}>{label}</div>
                {key===new Date().toISOString().slice(0,10)&&(
                  <span style={{fontSize:9,fontWeight:700,background:'#007AFF',color:'white',padding:'2px 8px',borderRadius:8}}>HOY</span>
                )}
              </div>
                <div style={{display:'flex',flexDirection:'column',gap:6}}>
...
═══════════════════════════════════════════════════════ */
const PORTION_EQUIVALENTS = {
  // Líquidos
  'ml':  [{g:240,l:'1 taza'},{g:200,l:'1 vaso'},{g:100,l:'½ vaso'},{g:15,l:'1 cda.'},{g:5,l:'1 cdita.'}],
  // Sólidos generales
  'g':   [{g:240,l:'1 taza'},{g:120,l:'½ taza'},{g:80,l:'⅓ taza'},{g:15,l:'1 cda.'},{g:5,l:'1 cdita.'},{g:30,l:'1 oz'}],
  // Pan/porciones
  'pan': [{g:80,l:'1 marraqueta'},{g:30,l:'1 rebanada'},{g:60,l:'½ marraqueta'}],
};

const getPortionLabel = (grams) => {
  const refs = [
    {g:5,  l:'1 cdita.'},  {g:15, l:'1 cda.'},
    {g:30, l:'1 oz'},       {g:50, l:'½ taza aprox.'},
    {g:80, l:'⅓ taza'},    {g:120,l:'½ taza'},
    {g:150,l:'¾ taza'},    {g:200,l:'1 vaso'},
    {g:240,l:'1 taza'},    {g:250,l:'1 taza grande'},
  ];
  const closest = refs.reduce((prev,curr)=>
    Math.abs(curr.g-grams)<Math.abs(prev.g-grams)?curr:prev
  );
  return Math.abs(closest.g-grams)<=grams*0.2 ? closest.l : null;
};
...
const QUICK_ESTIMATES = [
  {cat:'🍗 Proteínas',items:[
    {n:'Pechuga de pollo a la plancha',cal:165,prot:33,carbs:0,grasas:3.5,por:'150g aprox.'},
    {n:'Filete de vacuno a la parrilla',cal:230,prot:36,carbs:0,grasas:9,por:'150g aprox.'},
    {n:'Salmón al horno',cal:290,prot:29,carbs:0,grasas:18,por:'150g aprox.'},
    {n:'Huevo frito',cal:90,prot:6,carbs:0.5,grasas:7,por:'1 unidad'},
    {n:'Hamburguesa casera',cal:380,prot:26,carbs:2,grasas:30,por:'150g'},
  ]},
  {cat:'🍚 Carbohidratos',items:[
    {n:'Arroz cocido porción mediana',cal:200,prot:4,carbs:43,grasas:0.5,por:'1 taza'},
    {n:'Pasta cocida porción mediana',cal:220,prot:7,carbs:44,grasas:1,por:'1 taza'},
    {n:'Papa cocida mediana',cal:130,prot:3,carbs:30,grasas:0.1,por:'1 unidad'},
    {n:'Pan marraqueta',cal:230,prot:7,carbs:44,grasas:2.5,por:'1 unidad'},
    {n:'Choclo cocido',cal:130,prot:4,carbs:28,grasas:1.5,por:'1 mazorca'},
  ]},
  {cat:'🥗 Ensaladas',items:[
    {n:'Ensalada mixta simple',cal:45,prot:2,carbs:8,grasas:0.5,por:'1 plato'},
    {n:'Ensalada con aderezo',cal:120,prot:2,carbs:9,grasas:8,por:'1 plato'},
    {n:'Ensalada César con pollo',cal:380,prot:28,carbs:18,grasas:22,por:'1 plato'},
    {n:'Ensalada de palta y tomate',cal:195,prot:3,carbs:10,grasas:17,por:'1 plato'},
  ]},
  {cat:'🍲 Platos chilenos',items:[
    {n:'Cazuela completa',cal:265,prot:22,carbs:28,grasas:7,por:'1 plato'},
    {n:'Completo italiano',cal:480,prot:15,carbs:45,grasas:26,por:'1 unidad'},
    {n:'Churrasco con todo',cal:650,prot:35,carbs:52,grasas:30,por:'1 unidad'},
    {n:'Empanada de pino',cal:360,prot:14,carbs:38,grasas:16,por:'1 unidad'},
    {n:'Sopaipilla con pebre',cal:198,prot:3.5,carbs:28,grasas:8,por:'1 unidad'},
    {n:'Porción de papas fritas',cal:320,prot:4,carbs:44,grasas:15,por:'porción'},
  ]},
  {cat:'☕ Café y bebidas',items:[
    {n:'Café con leche',cal:90,prot:4,carbs:9,grasas:3.5,por:'1 taza'},
    {n:'Jugo de naranja natural',cal:110,prot:1.5,carbs:26,grasas:0,por:'1 vaso'},
    {n:'Cerveza lata',cal:150,prot:1.5,carbs:14,grasas:0,por:'350ml'},
    {n:'Bebida cola lata',cal:148,prot:0,carbs:37,grasas:0,por:'350ml'},
  ]},
];

function RestaurantEstimator({C, F, meal, onAdd, onClose}) {
  const [activeTab, setActiveTab] = useState(0);
  const [sizes] = useState({small:0.65,medium:1,large:1.4,xlarge:1.8});
  const [size, setSize] = useState('medium');

  return(
    <div onClick={onClose} style={{position:'fixed',inset:0,background:'rgba(0,0,0,0.6)',zIndex:65,display:'flex',alignItems:'flex-end'}}>
      <div onClick={e=>e.stopPropagation()} style={{width:'100%',background:C.surface,borderRadius:'26px 26px 0 0',padding:'18px 18px 44px',animation:'slideUp .3s ease',maxHeight:'88vh',overflowY:'auto'}}>
        <div style={{width:40,height:4,borderRadius:2,background:C.border,margin:'0 auto 14px'}}/>
        <div style={{fontSize:17,fontWeight:700,color:C.text,marginBottom:4}}>🍽️ Estimador rápido</div>
        <div style={{fontSize:12,color:C.textSec,marginBottom:14}}>Para cuando comes fuera y no hay etiqueta</div>

        {/* Size selector */}
        <div style={{display:'flex',gap:6,marginBottom:14}}>
          {[{k:'small',l:'S',sub:'pequeño'},{k:'medium',l:'M',sub:'normal'},{k:'large',l:'L',sub:'grande'},{k:'xlarge',l:'XL',sub:'extra'}].map(({k,l,sub})=>(
            <button key={k} className="tap" onClick={()=>setSize(k)} style={{
              flex:1,padding:'8px 4px',borderRadius:13,
              border:`1.5px solid ${size===k?'#007AFF':C.border}`,
              background:size===k?'#007AFF18':C.surfaceAlt,
              cursor:'pointer',fontFamily:F,textAlign:'center',
            }}>
              <div style={{fontSize:15,fontWeight:800,color:size===k?'#007AFF':C.textSec}}>{l}</div>
        ...
        <div style={{display:'flex',gap:0,borderBottom:`1px solid ${C.border}`,marginBottom:12,overflowX:'auto',scrollbarWidth:'none'}}>
          {QUICK_ESTIMATES.map((cat,i)=>(
            <button key={i} onClick={()=>setActiveTab(i)} style={{
              flexShrink:0,padding:'8px 12px',border:'none',background:'none',
              cursor:'pointer',fontFamily:F,fontSize:11,fontWeight:700,
              color:activeTab===i?'#007AFF':C.textSec,
              borderBottom:`2px solid ${activeTab===i?'#007AFF':'transparent'}`,
        ...
        <div style={{display:'flex',flexDirection:'column',gap:8}}>
          {QUICK_ESTIMATES[activeTab].items.map((item,i)=>{
            ...
            return(
              <div key={i} className="tap" onClick={()=>{
                const food={
                  id:Date.now()+i,
                  nombre:item.n+(size!=='medium'?` (${size==='small'?'porción pequeña':size==='large'?'porción grande':'porción extra grande'})`:''),
                  marca:'Estimado',cat:'Preparados',
                  porcion:100,cal,
                  prot:Math.round(item.prot*mult*10)/10,
                  carbs:Math.round(item.carbs*mult*10)/10,
                  grasas:Math.round(item.grasas*mult*10)/10,
                  fibra:0,emoji:'🍽️',grams:null,
                };
                onAdd(food);
                haptic('add');
              }} style={{
                display:'flex',alignItems:'center',gap:12,
                background:C.surfaceAlt,borderRadius:16,padding:'12px 14px',
                cursor:'pointer',border:`1px solid ${C.border}`,
              }}>
                <div style={{flex:1}}>
                  <div style={{fontSize:13,fontWeight:600,color:C.text}}>{item.n}</div>
                  <div style={{fontSize:11,color:C.textMuted,marginTop:1}}>{item.por} · porción {size==='small'?'pequeña':size==='large'?'grande':size==='xlarge'?'extra grande':'normal'}</div>
                </div>
...
/* ═══════════════════════════════════════════════════════
   GRÁFICO DE PESO — línea 30 días
═══════════════════════════════════════════════════════ */
function WeightChart({data, C, F}) {
  if(!data || data.filter(d=>d.w).length < 2) {
    return (
      <div style={{textAlign:'center',padding:'20px 0',color:C.textMuted,fontSize:12}}>
        Registra tu peso al menos 2 días para ver la evolución
      </div>
    );
  }
  const vals   = data.filter(d=>d.w).map(d=>d.w);
  const minW   = Math.min(...vals) - 1;
  const maxW   = Math.max(...vals) + 1;
  const W=300, H=80;
  const pts    = data.map((d,i)=>({
    x: Math.round((i/(data.length-1))*W),
    y: d.w ? Math.round(H - ((d.w-minW)/(maxW-minW))*H) : null,
    w: d.w, label: d.label,
  }));
  ...
  return (
    <div>
      <svg width="100%" viewBox={`0 0 ${W} ${H+20}`} style={{overflow:'visible'}}>
        ...
        {validPts.length>1&&(
          <polygon points={`${validPts[0].x},${H} ${polyline} ${validPts[validPts.length-1].x},${H}`}
            fill="url(#wg)"/>
        )}
        {/* Line */}
        {validPts.length>1&&(
          <polyline points={polyline} fill="none" stroke="#007AFF" strokeWidth={2.5} strokeLinecap="round" strokeLinejoin="round"/>
        )}
        {/* Dots */}
        {validPts.map((p,i)=>(
          <circle key={i} cx={p.x} cy={p.y} r={i===validPts.length-1?5:3}
            fill={i===validPts.length-1?'#007AFF':C.surface}
            stroke="#007AFF" strokeWidth={2}/>
        ))}
        {/* Labels start/end */}
        <text x={0} y={H+16} fontSize={9} fill={C.textMuted} fontFamily={F}>{data[0]?.label}</text>
        <text x={W} y={H+16} fontSize={9} fill={C.textMuted} fontFamily={F} textAnchor="end">{data[data.length-1]?.label}</text>
      </svg>
      <div style={{display:'flex',justifyContent:'space-between',marginTop:4}}>
        <div style={{fontSize:12,color:C.textSec}}>Inicio: <strong style={{color:C.text}}>{first} kg</strong></div>
        <div style={{fontSize:12,color:diff<0?'#34C759':diff>0?'#FF3B30':C.textSec,fontWeight:700}}>
          {diff<0?'▼':diff>0?'▲':'='} {Math.abs(diff)} kg
        </div>
        <div style={{fontSize:12,color:C.textSec}}>Ahora: <strong style={{color:C.text}}>{last} kg</strong></div>
      </div>
    </div>
  );
}
...
function ModalDetalle({food, meal, C, F, onClose, onAdd, onFav, isFav}) {
  ...
  const [mode, setMode] = useState(()=>LS.get('prefMode','porcion'));
  ...
  return (
    <div onClick={onClose} style={{position:'fixed',inset:0,background:'rgba(0,0,0,0.6)',zIndex:50,display:'flex',alignItems:'flex-end'}}>
      <div onClick={e=>e.stopPropagation()} style={{
        ...
        {/* Gram info banner with equivalent */}
        <div style={{background:`${C.primary}10`,borderRadius:13,padding:'10px 14px',marginBottom:16}}>
          <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:getPortionLabel(grams)?4:0}}>
            <span style={{fontSize:12,color:C.textSec,fontWeight:600}}>
              {mode==='porcion'?`1 porción = ${food.porcion||100}g`:`${grams}g seleccionados`}
            </span>
            <span style={{fontSize:13,fontWeight:800,color:C.primary}}>{v(food.cal)} kcal</span>
          </div>
          {getPortionLabel(grams)&&(
            <div style={{fontSize:11,color:C.textSec,fontWeight:500}}>
              ≈ {getPortionLabel(grams)} · Ajusta los gramos para cambiar la equivalencia
            </div>
          )}
        </div>
...
export default function App() {
  ...
  const [userAllergens,setUserAllergens] = useState(()=>LS.get('allergens',[])); // uid of item being edited
  ...
  const [newAchievement,setNewAchiev] = useState(null);
  ...
  useEffect(()=>{
    PhotoDB.load('photo_'+todayKey()).then(p=>{ if(p) setDayPhoto(p); });
  },[]);
  ...
  const objAccent = (OBJ_ACCENT[obj]||OBJ_ACCENT.mantener)[dark?'dark':'light'];
  const CA = {...C, accent:objAccent, glow:objAccent}; // C with objective accent
  ...
  useEffect(()=>{
    ...
    const check=()=>{
      ...
      if(h===9&&m<30&&!sent.d&&log.filter(r=>r.comida==='Desayuno').length===0){
        setToast('🌅 ¿Ya registraste tu desayuno?'); LS.set(key,{...sent,d:true});
      }
      if(h===14&&m<30&&!sent.l&&log.filter(r=>r.comida==='Almuerzo').length===0){
        setToast('☀️ ¡Hora de registrar el almuerzo!'); LS.set(key,{...sent,l:true});
      }
      if(h===21&&m<30&&!sent.n&&curPct<0.5){
        setToast('🌙 Llevas pocas calorías. ¿Olvidaste registrar algo?'); LS.set(key,{...sent,n:true});
      }
      /* Streak at risk alert at 9pm if nothing logged */
      const streakData=LS.get('streak',{days:0,last:''});
      if(h===21&&m<30&&!sent.s&&streakData.days>0&&log.length===0){
        setToast(`🔥 ¡Tu racha de ${streakData.days} días está en riesgo! Registra algo hoy.`);
        LS.set(key,{...sent,s:true});
      }
    };
    const ti=setInterval(check,60000); check();
    return ()=>clearInterval(ti);
  },[notifEnabled,log.length]);
  ...
  useEffect(()=>{
    if(dayPhoto) PhotoDB.save('photo_'+todayKey(), dayPhoto);
    else if(dayPhoto==='') PhotoDB.delete('photo_'+todayKey());
  },[dayPhoto]);
  ...
  useEffect(()=>{
    ...
    const achieved = {
      first_log:    log.length>0,
      water_goal:   agua>=8,
      streak_3:     streak.days>=3,
      streak_7:     streak.days>=7,
      all_meals:    MEALS.every(m=>log.some(r=>r.comida===m)),
      first_ex:     exercises.length>0,
      cal_goal:     pct>=0.9&&pct<=1.1,
      first_fav:    favorites.length>0,
      custom_food:  customFoods.length>0,
      diary_note:   dayNote.length>0,
      streak_14:    streak.days>=14,
      weight_track: weightHistory.length>=3,
    };
    Object.entries(achieved).forEach(([k,v])=>{
      if(v && !prev[k]){
        LS.set('achievements', {...prev,[k]:true});
        const labels = {
          first_log:'¡Primer registro!', water_goal:'¡Hidratación perfecta!',
          streak_3:'3 días seguidos 🔥', streak_7:'¡Una semana entera! 🏆',
          all_meals:'¡Día completo! ✅', first_ex:'¡Primer ejercicio! 💪',
          cal_goal:'¡Meta calórica! 🎯', first_fav:'⭐ Primer favorito',
          custom_food:'✨ Creador de alimentos', diary_note:'📝 Diario activo',
          streak_14:'¡14 días de racha! 🔥🏆', weight_track:'⚖️ Seguimiento de peso',
        };
        setNewAchiev({icon:'🏆', text: labels[k]||'Logro desbloqueado'});
        haptic('goal');
        setTimeout(()=>setNewAchiev(null), 3500);
      }
    });
  },[log.length, agua, streak.days, pct, exercises.length, favorites.length, customFoods.length, dayNote.length, weightHistory.length]);
  ...
  useEffect(()=>{
    const doReset=(today)=>{
      /* Save summary of previous day before resetting */
      ...
      if(prevLog.length>0){
        const summary=sumLog(prevLog);
        LS.set('summary_'+prevKey,{cal:Math.round(summary.cal),prot:Math.round(summary.prot),carbs:Math.round(summary.carbs),grasas:Math.round(summary.grasas),items:prevLog.length});
      }
      /* Load today's data (might already have some if app was used earlier) */
      setCurrentDay(today);
      setLog(LS.get('log_'+today,[]));
      setAgua(LS.get('agua_'+today,0));
      setExercises(LS.get('ex_'+today,[]));
      setDayNote(LS.get('note_'+today,''));
      PhotoDB.load('photo_'+today).then(p=>setDayPhoto(p||''));
      setFastStart(null); LS.set('fastStart',null);
      setStreak(LS.get('streak',{days:0,last:''}));
      setEditingItem(null);
      setToast('🌅 ¡Buenos días! Nuevo día comenzó');
    };
    ...
    /* Check every 30s AND on window focus (when user unlocks phone) */
    const ti=setInterval(checkDay,30000);
    const onFocus=()=>checkDay();
    window.addEventListener('focus',onFocus);
    window.addEventListener('visibilitychange',()=>{ if(!document.hidden) checkDay(); });
    return ()=>{
      clearInterval(ti);
  ...
  const autoMetas = calcMetas(tdee,obj);
  ...
  return (
    <div style={{fontFamily:F,minHeight:'100vh',background:C.bg,paddingBottom:88,transition:'background .3s'}}>
      ...
      {showHistory&&(
        <div style={{position:'fixed',inset:0,background:C.bg,zIndex:80,display:'flex',flexDirection:'column',animation:'fadeUp .3s ease'}}>
          <div style={{background:C.surface,borderBottom:`1px solid ${C.border}`,padding:'14px 18px',display:'flex',alignItems:'center',gap:12,flexShrink:0}}>
            <button onClick={()=>setShowHistory(false)} style={{background:'none',border:'none',fontSize:16,cursor:'pointer',color:'#007AFF',fontFamily:F,fontWeight:600}}>← Volver</button>
      ...
      {newAchievement&&(
        <div style={{
          ...
          background:'linear-gradient(135deg,#1A2C22,#285C3E)',
          color:'white',padding:'14px 22px',borderRadius:22,
          ...
          <div>
            <div style={{fontSize:10,color:'rgba(255,255,255,0.5)',fontWeight:600,marginBottom:2,textTransform:'uppercase',letterSpacing:.5}}>¡Logro desbloqueado!</div>
            <div style={{fontSize:14,fontWeight:700}}>{newAchievement.text}</div>
          </div>
        </div>
      )}
      ...
      <div style={{
          ...
          <div style={{display:'flex',alignItems:'center',gap:10}}>
            ...
            <div>
              ...
              <div style={{color:C.textSec,fontSize:10,fontWeight:500,marginTop:1}}>
                {new Date().toLocaleDateString('es-CL',{weekday:'long',day:'numeric',month:'short'})} · {(OBJ_ACCENT[obj]||OBJ_ACCENT.mantener).name}
              </div>
            </div>
          </div>
          <div style={{display:'flex',alignItems:'center',gap:10}}>
        ...
        <div style={{height:3,background:C.border,borderRadius:3,overflow:'hidden'}}>
          <div style={{
            ...
            background:tot.cal>metas.cal?C.red:objAccent,
      ...
      <div style={{padding:'14px 14px 0'}}>
        ...
        {tab===0&&<div className={tabAnim}>
          ...
          {(()=>{
            ...
            return(
              <div style={{
                background:C.surface,borderRadius:18,padding:'13px 16px',marginBottom:12,
                border:`1px solid ${C.border}`,
              }}>
                <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:8}}>
                  <div style={{fontSize:12,fontWeight:700,color:C.text}}>📊 vs ayer a esta hora</div>
                  <button className="tap" onClick={()=>setShowHistory(true)} style={{fontSize:11,color:'#007AFF',background:'none',border:'none',cursor:'pointer',fontFamily:F,fontWeight:600}}>Ver historial</button>
                </div>
                <div style={{display:'flex',gap:10,alignItems:'center'}}>
                  <div style={{flex:1}}>
                    <div style={{fontSize:10,color:C.textMuted,fontWeight:600,marginBottom:2}}>Hoy</div>
                    <div style={{fontSize:18,fontWeight:800,color:C.text,lineHeight:1}}>{Math.round(tot.cal)}<span style={{fontSize:10,color:C.textMuted,fontWeight:400}}> kcal</span></div>
                  </div>
                  <div style={{
                    padding:'4px 10px',borderRadius:10,
                    background:diff>0?'#FF3B3018':diff<0?'#34C75918':'#F2F2F7',
                    color:diff>0?'#FF3B30':diff<0?'#34C759':C.textMuted,
                    fontSize:12,fontWeight:700,flexShrink:0,
                  }}>
                    {diff>0?'+':''}{diff} kcal
                  </div>
                  <div style={{flex:1,textAlign:'right'}}>
                    <div style={{fontSize:10,color:C.textMuted,fontWeight:600,marginBottom:2}}>Ayer total</div>
                    <div style={{fontSize:18,fontWeight:800,color:C.textSec,lineHeight:1}}>{summary.cal}<span style={{fontSize:10,color:C.textMuted,fontWeight:400}}> kcal</span></div>
                  </div>
                </div>
                {diff<-100&&<div style={{marginTop:8,fontSize:11,color:'#34C759',fontWeight:600}}>✨ Llevas {Math.abs(diff)} kcal menos que ayer. ¡Buen ritmo!</div>}
                {diff>200&&<div style={{marginTop:8,fontSize:11,color:'#FF9500',fontWeight:600}}>⚡ Llevas más que ayer. Considera algo más liviano.</div>}
              </div>
            );
          })()}
              ...
              <div style={{flexShrink:0,position:'relative',width:120,height:120}}>
                <svg width={120} height={120} viewBox="0 0 120 120">
                  ...
                  <circle cx={60} cy={60} r={ringR} fill="none"
                    stroke={tot.cal>metas.cal?C.red:objAccent} strokeWidth={11}
            ...
            <div style={{display:'flex',gap:4}}>
              {Array.from({length:8}).map((_,i)=>(
                <button key={i} className="tap" onClick={()=>{setAgua(i<agua?i:i+1);haptic('light');}} style={{
                  ...
                  background:i<agua?objAccent:objAccent+'28',
          ...
          <div style={{background:C.surface,borderRadius:20,padding:'14px 16px',marginBottom:12,border:`1px solid ${C.border}`,boxShadow:dark?'none':'0 1px 6px rgba(0,0,0,0.04)'}}>
            <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:10}}>
              ...
              <label className="tap" style={{display:'flex',alignItems:'center',gap:5,padding:'5px 10px',borderRadius:12,border:`1px solid ${C.border}`,background:C.surfaceAlt,cursor:'pointer',fontSize:11,fontWeight:600,color:C.textSec}}>
                ...
                <input type="file" accept="image/*" capture="environment" style={{display:'none'}} onChange={e=>{
                  ...
                  reader.onload=(ev)=>{
                    PhotoDB.save('photo_'+todayKey(), ev.target.result);
                    setDayPhoto(ev.target.result);
                    haptic('success');
            ...
            {dayPhoto&&(
              <div style={{position:'relative',marginBottom:10}}>
                <img src={dayPhoto} alt="Foto del día" style={{width:'100%',borderRadius:12,maxHeight:180,objectFit:'cover',display:'block'}}/>
                <button className="tap" onClick={()=>{setDayPhoto(null);LS.set('photo_'+todayKey(),'');}} style={{position:'absolute',top:6,right:6,width:28,height:28,borderRadius:8,border:'none',background:'rgba(0,0,0,0.5)',color:'white',fontSize:13,cursor:'pointer',display:'flex',alignItems:'center',justifyContent:'center'}}>✕</button>
              </div>
            )}
        ...
        {tab===1&&<div className={tabAnim}>
          ...
          {/* Mini resumen comida actual */}
          {log.filter(r=>r.comida===meal).length>0&&(()=>{
            const mt=sumLog(log.filter(r=>r.comida===meal));
            return(
              <div style={{background:`${objAccent}12`,borderRadius:14,padding:'9px 14px',marginBottom:10,border:`1px solid ${objAccent}30`,display:'flex',justifyContent:'space-between',alignItems:'center'}}>
                <span style={{fontSize:12,color:C.text,fontWeight:600}}>{meal}: <strong style={{color:objAccent}}>{Math.round(mt.cal)} kcal</strong></span>
                <div style={{display:'flex',gap:8}}>
          ...
          {/* Sin búsqueda: mostrar recientes + favoritos prominentes */}
          {!q&&recent.length>0&&(
            <div style={{marginBottom:14,animation:'fadeUp .25s ease'}}>
              <div style={{fontSize:13,fontWeight:700,color:C.text,marginBottom:10}}>🕐 Usados recientemente</div>
              <div style={{display:'grid',gridTemplateColumns:'repeat(4,1fr)',gap:8}}>
                {recent.slice(0,8).map(a=>(
                  <button key={a.id} className="tap" onClick={()=>{haptic('light');setDetail(a);}} style={{
                    background:C.surface,border:`1px solid ${C.border}`,
                    borderRadius:16,padding:'10px 6px',textAlign:'center',
                    cursor:'pointer',fontFamily:F,
                  }}>
                    <div style={{fontSize:24,marginBottom:4}}>{a.emoji}</div>
                    <div style={{fontSize:9,fontWeight:700,color:C.text,lineHeight:1.2,overflow:'hidden',textOverflow:'ellipsis',whiteSpace:'nowrap'}}>{a.nombre.split(' ').slice(0,2).join(' ')}</div>
          ...
          <div style={{fontSize:11,color:C.textMuted,fontWeight:600,marginBottom:10}}>
            {foods.length} productos
            {userAllergens.length>0&&<span style={{marginLeft:8,color:'#FF9500',fontWeight:700}}>⚠️ Filtrando {userAllergens.length} alérgeno{userAllergens.length>1?'s':''}</span>}
          </div>
                ...
                <div key={a.id} onClick={()=>setDetail(a)} style={{
                  ...
                  <div style={{flex:1,minWidth:0}}>
                    ...
                    <div style={{display:'flex',gap:6,marginTop:4,flexWrap:'wrap'}}>
                      ...
                      {getFoodAllergens(a.id).map(al=>(
                        <span key={al} style={{fontSize:9,fontWeight:700,color:ALLERGEN_LABELS[al]?.color||'#888',background:(ALLERGEN_LABELS[al]?.color||'#888')+'18',padding:'1px 6px',borderRadius:6,border:'1px solid '+(ALLERGEN_LABELS[al]?.color||'#888')+'40'}}>
                          {ALLERGEN_LABELS[al]?.icon} {ALLERGEN_LABELS[al]?.label}
                        </span>
                      ))}
                    </div>
                  </div>
        ...
        {tab===2&&<div className={tabAnim}>
          ...
          {log.length===0?(
                      ...
                      <div style={{display:'flex',alignItems:'center',gap:10,padding:'11px 14px'}}>
                        ...
                        <div style={{flex:1,minWidth:0}} onClick={()=>setEditingItem(editingItem===item.uid?null:item.uid)}>
                          ...
                          <div style={{display:'flex',gap:5,marginTop:3,flexWrap:'wrap'}}>
                            ...
                            <span style={{fontSize:10,color:C.textMuted,fontWeight:500}}>{(item.grams||item.porcion||100)}g</span>
                          </div>
                        </div>
                      ...
                      {editingItem===item.uid&&(
                        <div style={{padding:'10px 14px 14px',borderTop:`1px solid ${C.border}`,background:C.surfaceAlt,animation:'fadeUp .2s ease'}}>
                          ...
                          <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginTop:10}}>
                            ...
                            <button className="tap" onClick={()=>{setLog(log.filter(r=>r.uid!==item.uid));setEditingItem(null);haptic('medium');}} style={{padding:'6px 12px',borderRadius:10,border:'none',background:'#FF3B3018',color:'#FF3B30',fontSize:11,fontWeight:700,cursor:'pointer',fontFamily:F}}>🗑️ Eliminar</button>
                          </div>
                        </div>
                      )}
                    </div>
            ...
            <button className="tap" onClick={()=>{
  if(window.confirm('¿Reiniciar el día? Se borrarán todas las comidas registradas hoy. El historial se guardará.')){
    LS.set('log_'+todayKey(), []);
    setLog([]);
    setExercises([]);
    LS.set('ex_'+todayKey(), []);
    setAgua(0);
    haptic('medium');
    setToast('🗑️ Día reiniciado');
  }
}} style={{
          ...
          <div style={{background:C.surface,borderRadius:22,padding:'18px',marginBottom:12,boxShadow:`0 2px 14px rgba(0,0,0,${dark?.15:.07})`}}>
            ...
            <div style={{display:'flex',alignItems:'center',gap:14,marginBottom:18}}>
              <div style={{position:'relative'}}>
                ...
                <button className="tap" onClick={()=>{
                  const emojis=['🧑','👩','🧔','👩‍🦱','🧑‍🦰','🧑‍🦳','🧑‍🦲','😊','💪','🏃'];
                  const cur=emojis.indexOf(avatar);
                  setAvatar(emojis[(cur+1)%emojis.length]);
                  haptic('light');
                }} style={{
            ...
            {/* Gráfico de peso */}
            <div style={{marginTop:16,background:C.surface,borderRadius:20,padding:'16px',border:`1px solid ${C.border}`}}>
              <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:14}}>
                <div style={{fontSize:14,fontWeight:700,color:C.text}}>⚖️ Evolución de peso</div>
                <button className="tap" onClick={()=>{
                  ...
                  const existing=weightHistory.findIndex(e=>e.date===today);
                  if(existing>=0){
                    setWeightHistory(weightHistory.map((e,i)=>i===existing?{...e,w}:e));
                  } else {
                    setWeightHistory([...weightHistory,{date:today,w,label}].slice(-30));
                  }
                  haptic('success');
                  setToast(`⚖️ ${w} kg registrado`);
              ...
              <WeightChart
                data={Array.from({length:30},(_,i)=>{
                  ...
                  return {date:key,label,w:entry?.w||null};
                })}
                C={C} F={F}
              />
            </div>
            ...
            <div style={{marginTop:14,background:C.surface,borderRadius:18,padding:'14px 16px',border:`1px solid ${C.border}`}}>
              <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:12}}>
                <div>
                  <div style={{fontSize:13,fontWeight:700,color:C.text}}>🎯 Metas diarias</div>
                  <div style={{fontSize:10,color:C.textSec,marginTop:1}}>{customMetas?'Personalizadas':'Calculadas automáticamente'}</div>
                </div>
                {customMetas&&(
                  <button className="tap" onClick={()=>{resetMetasToAuto();haptic('light');}} style={{fontSize:11,color:'#007AFF',background:'none',border:'none',cursor:'pointer',fontFamily:F,fontWeight:600}}>Auto</button>
                )}
              </div>
              <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:8}}>
                {[
                  {l:'Calorías',k:'cal',unit:'kcal',c:'#1C1C1E'},
                  {l:'Proteínas',k:'prot',unit:'g',c:C.red},
                  {l:'Carbohidratos',k:'carbs',unit:'g',c:C.amber},
                  {l:'Grasas',k:'grasas',unit:'g',c:C.purple},
                ].map(({l,k,unit,c2=null,c})=>(
                  <div key={k} style={{background:C.surfaceAlt,borderRadius:14,padding:'10px 12px',border:`1px solid ${C.border}`}}>
                    <div style={{fontSize:10,color:C.textSec,fontWeight:600,marginBottom:5,textTransform:'uppercase',letterSpacing:.3}}>{l}</div>
                    <div style={{display:'flex',alignItems:'center',gap:4}}>
                      <input type="number"
                        value={metas[k]}
                        onChange={e=>{
                          const val=+e.target.value||0;
                          setCustomMetas({...metas,[k]:val});
                          haptic('light');
                        }}
                        style={{
                          flex:1,padding:'4px 6px',border:`1.5px solid ${c}40`,
                          borderRadius:9,fontSize:15,fontWeight:800,
                          color:c,background:C.surface,outline:'none',fontFamily:F,
                          width:0, // flex will override
                        }}/>
                      <span style={{fontSize:10,color:C.textMuted,flexShrink:0}}>{unit}</span>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div style={{marginTop:16}}>
              <div style={{fontSize:13,fontWeight:700,color:C.text,marginBottom:10}}>🚫 Mis alergias e intolerancias</div>
              <div style={{fontSize:11,color:C.textSec,marginBottom:10,lineHeight:1.4}}>
                Los alimentos marcados se ocultarán del buscador automáticamente.
              </div>
              <div style={{display:'flex',flexWrap:'wrap',gap:8}}>
                {ALL_ALLERGENS.map(al=>{
                  const info=ALLERGEN_LABELS[al];
                  const active=userAllergens.includes(al);
                  return(
                    <button key={al} className="tap" onClick={()=>{
                      haptic('light');
                      setUserAllergens(prev=>active?prev.filter(a=>a!==al):[...prev,al]);
                    }} style={{
                      display:'flex',alignItems:'center',gap:6,
                      padding:'8px 14px',borderRadius:20,
                      border:`1.5px solid ${active?info.color:C.border}`,
                      background:active?`${info.color}18`:C.surfaceAlt,
                      cursor:'pointer',fontFamily:F,
                      transition:'all .18s ease',
                    }}>
                      <span style={{fontSize:16}}>{info.icon}</span>
                      <span style={{fontSize:12,fontWeight:active?700:500,color:active?info.color:C.textSec}}>{info.label}</span>
                      {active&&<span style={{fontSize:10,color:info.color,fontWeight:700}}>✓</span>}
                    </button>
                  );
                })}
              </div>
              {userAllergens.length>0&&(
                <div style={{marginTop:10,padding:'8px 12px',background:'#FF3B3010',borderRadius:12,border:'1px solid #FF3B3030',fontSize:11,color:'#FF3B30',fontWeight:600}}>
                  ⚠️ Ocultando alimentos con: {userAllergens.map(a=>ALLERGEN_LABELS[a]?.label).join(', ')}
                </div>
              )}
            </div>
            ...
            {/* Reset account */}
            <button className="tap" onClick={()=>{
              if(window.confirm('¿Reiniciar toda la app? Se borrarán tus datos y empezarás de cero.')){
                localStorage.clear(); window.location.reload();
              }
            }} style={{marginTop:8,width:'100%',padding:'11px',borderRadius:14,border:`1px solid ${C.border}`,background:C.surfaceAlt,color:C.textMuted,fontSize:12,fontWeight:600,cursor:'pointer',fontFamily:F}}>
        ...
        {[{icon:'🏠',lbl:'Inicio'},{icon:'➕',lbl:'Agregar'},{icon:'📋',lbl:'Mi Día'},{icon:'📊',lbl:'Stats'},{icon:'🎯',lbl:'Perfil'}].map(({icon,lbl},i)=>(
          <button key={i} className="nav-btn tap" onClick={()=>goTab(i)} style={{
            ...
            <div style={{
              ...
              background:tab===i?objAccent+'20':'transparent',
              display:'flex',alignItems:'center',justifyContent:'center',
              fontSize:20,
            ...
            <div style={{
              ...
              color:tab===i?objAccent:C.textMuted,
