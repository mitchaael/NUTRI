...
function Logo({size=40}) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
      <rect width="100" height="100" rx="22" fill="#1A2C22"/>
      <circle cx="50" cy="50" r="28" fill="none" stroke="#6ECC8A" strokeWidth="5"/>
      <path d="M34 50 Q42 38 50 50 Q58 62 66 50" stroke="#6ECC8A" strokeWidth="3" strokeLinecap="round" fill="none"/>
      <circle cx="50" cy="50" r="5" fill="#6ECC8A"/>
    </svg>
  );
}
