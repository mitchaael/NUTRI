...
@keyframes fadeUp{from{opacity:0;transform:translateY(18px)}to{opacity:1;transform:translateY(0)}}
  ...
  return (
    <div style={{fontFamily:F,height:'100dvh',background:C.bg,display:'flex',flexDirection:'column',overflow:'hidden',transition:'background .3s'}}>
  ...
  fontSize:14,fontWeight:600,cursor:'pointer',fontFamily:F,marginTop:4,
      ...
      {/* ══ BOTTOM NAV ══ */}
      <div style={{position:'sticky',bottom:0,zIndex:30,background:C.navBg,backdropFilter:'blur(16px)',borderTop:`1px solid ${C.border}`,padding:'8px 8px calc(18px + env(safe-area-inset-bottom))',display:'flex',transition:'background .3s'}}>
