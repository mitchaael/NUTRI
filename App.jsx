  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <img src="/icon-192.png" alt="Calorú"
...
function Onboarding({onDone}) {
  ...
  const steps=[
    ...
    <div key={0} style={{display:'flex',flexDirection:'column',alignItems:'center',padding:'40px 28px',gap:24,textAlign:'center'}}>
      <img src="/icon-192.png" alt="Calorú" style={{width:80,height:80,borderRadius:20,boxShadow:'0 8px 24px rgba(0,0,0,0.15)'}}/>
      <div>
...
@keyframes fadeUp{from{opacity:0;transform:translateY(18px)}to{opacity:1;transform:translateY(0)}}
  ...
  return (
    <div style={{fontFamily:F,minHeight:'100vh',background:C.bg,paddingBottom:88,transition:'background .3s'}}>
      ...
      <div ref={mainRef}
        onTouchStart={e=>{if(mainRef.current)mainRef.current._ty=e.touches[0].clientY;}}
        onTouchEnd={e=>{try{if(mainRef.current?.scrollTop===0&&(e.changedTouches[0].clientY-(mainRef.current._ty||0))>70){haptic('light');setToast('Actualizado ✓');setTimeout(()=>setToast(''),800);}}catch{}}}
