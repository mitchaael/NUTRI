...
const SUPABASE_URL = import.meta.env.VITE_SUPABASE_URL || 'https://fywghvfdwltayylswnid.supabase.co';
const SUPABASE_KEY = import.meta.env.VITE_SUPABASE_KEY || 'sb_publishable_sJg-yVo5CteuhIjinAVyoQ_edrG0cgD';
